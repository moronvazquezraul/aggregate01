...
db.encargos.insertMany([
    {_id:2,nombre:"Jose Maria Romero Romero",nacionalidad:"España",pedidos:[{telefonos:["Samsung Galaxy M12","Samsung Galaxy M12","Huawei P30 Black","Black Shark 4"]},{fechasdepedido:[new Date("2021-08-26"),new Date("2021-08-20"),new Date("2021-07-16"),new Date("2021-07-02")]}],preciototal:1112.99,edad:45,cantidadunidades:4,fechacontrato: new Date("2021-01-22")},
